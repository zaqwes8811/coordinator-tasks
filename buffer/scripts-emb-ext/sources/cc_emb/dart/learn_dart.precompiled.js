...
function dart_precompiled($collectedClasses) {
  ...
  function InputField(maxLength, name) {
    this.maxLength = maxLength;
    this.name = name;
  }
  InputField.builtin$cls = "InputField";
  if (!"name" in InputField)
    InputField.name = "InputField";
  $desc = $collectedClasses.InputField;
  if ($desc instanceof Array)
    $desc = $desc[1];
  InputField.prototype = $desc;
  return [Null, Object, InputField];
}
